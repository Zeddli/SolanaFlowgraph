        ...
        return (
          <div className="h-[400px] border rounded-lg p-4 bg-gray-50">
            <div className="flex flex-col h-full">
              ...
              <div className="flex-1 grid grid-cols-7 gap-1.5 auto-rows-fr content-start overflow-y-auto">
                {Array(7 * 24).fill(0).map((_, idx) => {
                  ...
                  return (
                    <div 
                      key={idx} 
                      className={`${bgColor} rounded-sm h-4 w-full`} 
                      title={`${Math.floor(intensity * 1000)} transactions`}
                    ></div>
                  );
                })}
              </div>
